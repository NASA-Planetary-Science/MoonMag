...
def eval_Bi_Schmidt(n,m,g_nm,h_nm, x,y,z,r, omega=None, t=None):
    ...
    if n==1:
        ...
        if m==0:
            ...
            rt429o2 = sqrt(429/2)
            Bx = Bx * rt429o2*( g_nm*-1/2*x*z*(33*x**8 - 141*y**8 + 602*y**6*z**2 + 420*y**4*z**4 - 2*x**6*(285*y**2 + 103*z**2) + 42*x**4*(6*y**4 + 83*y**2*z**2 + 2*z**4) + 42*x**2*(17*y**6 - 105*y**4*z**2 - 20*y**2*z**4)) + h_nm*y*z*(-108*x**8 + 9*y**8 - 33*y**6*z**2 - 42*y**4*z**4 + 21*x**6*(17*y**2 + 31*z**2) + 7*x**4*(33*y**4 - 365*y**2*z**2 - 30*z**4) + x*82*(-225*y**6 + 1113*y**4*z**2 + 420*y**2*z**4)) )
